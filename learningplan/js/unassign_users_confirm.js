 ...
 */
M.util.moodle_show_user_confirm_dialog = function(e, args) {
    ...
    YUI().use('moodle-core-notification-confirm', function(Y) {
        ...
        confirmationDialogue.on('complete-yes', function(e) {
            ...
            if (target.test('a')) {
                window.location = M.cfg.wwwroot + '/local/learningplan/assign_courses_users.php?planid='+args.callbackargs.planid+'&unassignuser='+args.callbackargs.userid;
